...
document.getElementById('decrease').addEventListener('click', function () {
    var setMinutes = Number(document.getElementById('time').innerText);
    setMinutes = setMinutes <= 0 ? setMinutes : --setMinutes;
    document.getElementById('time').innerHTML = "".concat(setMinutes);
});
...
//# sourceMappingURL=bundleTimer.js.map
